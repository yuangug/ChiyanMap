...
namespace LanguageManager {
    ...
    "NATIVE_IME_TOOLTIP": "Open native input box for Chinese/IME text",
    ...
    "NATIVE_IME_TOOLTIP": "\u6253\u5f00\u539f\u751f\u8f93\u5165\u6846\u4ee5\u8f93\u5165\u4e2d\u6587\u6216 IME \u6587\u672c",
    "NEW_WP_BUTTON": " + \u65b0\u5efa\u8def\u5f84\u70b9",
    ...
    "NATIVE_IME_TOOLTIP": "\u6253\u958b\u539f\u751f\u8f38\u5165\u6846\u4ee5\u8f38\u5165\u4e2d\u6587\u6216 IME \u6587\u672c",
    "NEW_WP_BUTTON": " + \u65b0\u5efa\u8def\u5f91\u9ede",
    ...
    static std::string GetBuiltinExtraText(const std::string& key, const std::string& langCode) {
        static const std::unordered_map<std::string, std::string> en = {
            ...
            {"MODERN_WAYPOINT_MANAGER", "Waypoint Manager"},
            {"MODERN_NEW_WAYPOINT", "New Waypoint"},
            {"MODERN_WAYPOINT_EMPTY", "No waypoints found"},
            {"NATIVE_IME_TOOLTIP", "Open native input box for Chinese/IME text"},
            {"MODERN_DEATH_MANAGER", "Death Records"},
            {"MODERN_DIMENSION_MISMATCH", "Different dimension"},
            {"MODERN_COMPASS_UNAVAILABLE", "Compass unavailable"},
        ...
        static const std::unordered_map<std::string, std::string> zhCN = {
            ...
            {"MODERN_INTERFACE", "界面"},
            {"MODERN_WAYPOINT_MANAGER", "地标管理"},
            {"MODERN_NEW_WAYPOINT", "新建地标"},
            {"MODERN_WAYPOINT_EMPTY", "未找到地标"},
            {"NATIVE_IME_TOOLTIP", "打开原生输入框以输入中文或 IME 文本"},
            {"MODERN_DEATH_MANAGER", "死亡记录"},
            {"MODERN_DIMENSION_MISMATCH", "不在当前维度"},
            {"MODERN_COMPASS_UNAVAILABLE", "蓝牙指南针未连接"},
        ...
        static const std::unordered_map<std::string, std::string> zhTW = {
            ...
            {"MODERN_BLUETOOTH_DETAIL", "mcompass BLE 同步"},
            {"MODERN_INTERFACE", "介面"},
            {"MODERN_WAYPOINT_MANAGER", "地標管理"},
            {"MODERN_NEW_WAYPOINT", "新增地標"},
            {"MODERN_WAYPOINT_EMPTY", "找不到地標"},
            {"NATIVE_IME_TOOLTIP", "打開原生輸入框以輸入中文或 IME 文本"},
            {"MODERN_DEATH_MANAGER", "死亡紀錄"},
            {"MODERN_DIMENSION_MISMATCH", "不在目前維度"},
            {"MODERN_COMPASS_UNAVAILABLE", "藍牙指南針未連線"},
